...
plot(strptime(df1$Date, "%d/%m/%Y %H:%M:%S"),df1$Voltage , type="l", xlab="datetime", ylab="Voltage")
...
legend("topright", c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), lty=1:1, lwd=2, col=c("black", "red", "blue"),bty="n",cex=0.70)
plot(strptime(df1$Date, "%d/%m/%Y %H:%M:%S"),df1$Global_reactive_power , type="l", xlab="datetime", ylab="GLobal-reactive_power")
